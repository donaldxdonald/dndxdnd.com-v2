...
export default function Sidebar({ className }: ComponentProps<'aside'>) {
  ...
  return (
    <aside className={`h-screen hidden fixed top-0 md:flex flex-col items-center px-2 pt-20 pb-28 left-[10vw] -translate-x-full xl:left-[50vw] xl:-translate-x-136 ${className}`}>
